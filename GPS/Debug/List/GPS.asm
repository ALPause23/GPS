...
; 0000 001F             SPDR = qaz;
	OUT  0xF,R16
; 0000 0020             while(!(SPSR & (1<<SPIF)));//подождем пока данные передадутс€
_0xC:
	SBIS 0xE,7
	RJMP _0xC
; 0000 0021             //сгенерируем отрицательный фронт дл€ записи в STORAGE REGISTER
...
; 0003 003F   //  ”станавливаетс€, когда регистр свободен
